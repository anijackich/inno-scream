...
class Scream(BaseModel):
    ...
    Attributes:
        ...
        reactions (dict[str, int]): Mapping of reaction emoji to reaction count.
    """
...
class Stats(BaseModel):
    ...
    Attributes:
        ...
        reactions_count (dict[str, int]): Mapping of reaction emoji to how many times each was received.
    """
